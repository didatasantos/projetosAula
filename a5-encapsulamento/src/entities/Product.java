...
public class Product {
	private String name; /* ENCAPSULAMENTO DE INSTÂNCIAS, ELA NÃO PODERÁ SER CHAMADA DE OUTRA CLASSE, PORÉM HÁ UMA FORMA, PRECISARÁ SER CRIADO UM
	MÉTODO COM AS REFERIDAS MODIFICAÇÕES, A EXEMPOS DOS getName e setName*/
